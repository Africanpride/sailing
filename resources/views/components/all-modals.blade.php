<div>
    <div id="hs-sign-out-alert-small-window"
        ...
        <div
            ...
            <div
                class="relative flex flex-col bg-white shadow-lg rounded-xl dark:bg-gray-800 dark:shadow-slate-700/[.7]
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-gray-800 dark:text-gray-400">
                                ...
                                At the same time realize that novbody likes a nosy neighbor. Give the user just enough
                                to know that something awesome is around the corner and then get out of the way. Write
    ...
    <div id="mobile-menu"
        class="hs-overlay hidden size-full w-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto pointer-events-none  ">
        <div
            ...
            <div
                ...
                <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
                        ...
                        <div
                            ...
                            <div class="lg:ms-4 flex">
                                ...
                                <a class="inline-flex flex-shrink-0 justify-center items-center h-9 w-9 font-medium rounded-full text-gray-800 hover:bg-gray-200 dark:text-gray-200 dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                    ...
                                    <svg class="flex-shrink-0 w-3.5 h-3.5" width="48" height="50"
                    ...
                    <button type="button"
                        ...
                        data-hs-overlay="#mobile-menu" data-hs-overlay-close>
                        <span class="sr-only">Close</span>
                ...
                <div class="h-auto overflow-y-auto">
                    <div class="p-2 grid grid-cols-2 gap-2">
                        ...
                        <x-mobile-menu route='about'>
                            About
                        </x-mobile-menu>

                        @php
                            $costrad = App\Models\Institute::find(5);
                            $costradLink = 'institutes.show';
                            $slug = [$costrad->slug];
                        @endphp
                        <x-mobile-menu :route="$costradLink" :slug="$slug">
                        ...
                        <a href="{{ route('institutes.index') }}">
                            <button type="button"
                                class="py-3 px-4 flex items-center justify-between gap-x-2 text-xs font-medium cursor-pointer rounded-lg border w-full border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 uppercase ">
                                <span>Institutes</span>
                                <x-lucide-globe-2 class="w-5 h-5 text-current" />
                            </button>
                        </a>


                        <x-mobile-menu route='contact'>
                            Contact
                        </x-mobile-menu>
                        <x-mobile-menu route='publications.show'>
                            Publications
                        </x-mobile-menu>
                        <x-mobile-menu route='donate'>
                            Donate
                        </x-mobile-menu>
                    </div>
