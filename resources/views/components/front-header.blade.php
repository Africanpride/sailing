      ...
      <nav class="relative max-w-[85rem] w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8"
          ...
          <div id="navbar-collapse-with-animation"
              ...
              <div
                  ...
                  <a class="font-medium text-blue-600 sm:py-6 dark:text-blue-500" href="{{ route('home') }}"
                  ...
                  <div
                      ...
                      <div
                          ...
                          <div
                              ...
                              <button type="button"
                                  class=" flex justify-between w-full items-center text-sm text-gray-800 rounded-lg py-2 px-3 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                                  Sub Menu
                                  <svg class="sm:-rotate-90 flex-shrink-0 ms-2 w-4 h-4 text-gray-600"
                  ...
                  {{-- <div class="flex md:justify-between items-center gap">
                      <a class="inline-flex flex-shrink-0 justify-center items-center h-9 w-9 font-medium rounded-full text-gray-800 hover:bg-gray-200 dark:text-gray-200 dark:hover:bg-gray-800 "
