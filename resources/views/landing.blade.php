<x-participant-layout>
    <div class="flex min-h-screen bg-gray-100">
        <aside class="hidden sm:flex sm:flex-col">
            <a class="inline-flex h-20 w-20 items-center justify-center bg-purple-600 hover:bg-purple-500 focus:bg-purple-500"
                href="#">
                <svg class="h-12 w-12" fill="none" viewBox="0 0 64 64">
            ...
            <div class="flex flex-grow flex-col justify-between bg-gray-800 text-gray-500">
                <nav class="mx-4 my-6 flex flex-col space-y-4">
                    <a class="inline-flex items-center justify-center rounded-lg py-3 hover:bg-gray-700 hover:text-gray-400 focus:bg-gray-700 focus:text-gray-400"
                        href="#">
                    ...
                    <a class="inline-flex items-center justify-center rounded-lg bg-white py-3 text-purple-600"
                        href="#">
                ...
                <div class="inline-flex h-20 w-20 items-center justify-center border-t border-gray-700">
                    <button
                        class="rounded-lg p-3 hover:bg-gray-700 hover:text-gray-400 focus:bg-gray-700 focus:text-gray-400">
        ...
        <div class="flex-grow text-gray-800">
            <header class="flex h-20 items-center bg-white px-6 sm:px-10">
                <button
                    class="relative mr-2 block flex-shrink-0 rounded-full p-2 text-gray-600 hover:bg-gray-100 hover:text-gray-800 focus:bg-gray-100 focus:text-gray-800 sm:hidden">
                ...
                <div class="relative w-full max-w-md sm:-ml-2">
                    <svg class="absolute ml-2 mt-2.5 h-6 w-6 text-gray-400" aria-hidden="true" viewBox="0 0 20 20"
                        fill="currentColor">
                    ...
                    <input
                        ...
                        type="text" role="search" placeholder="Search..." />
                </div>
                <div class="ml-auto flex flex-shrink-0 items-center">
                    <button class="inline-flex items-center rounded-lg p-2 hover:bg-gray-100 focus:bg-gray-100">
                        ...
                        <span class="ml-2 mr-2 h-12 w-12 overflow-hidden rounded-full bg-gray-100 sm:ml-3">
                            <img class="h-full w-full object-cover"
                                src="https://randomuser.me/api/portraits/women/68.jpg" alt="user profile photo">
                        </span>
                        <svg class="hidden h-6 w-6 text-gray-300 sm:block" aria-hidden="true" viewBox="0 0 20 20"
                            fill="currentColor">
                            <path fill-rule="evenodd"
                    ...
                    <div class="ml-3 space-x-1 border-l pl-3">
                        <button
                            ...
                            <span
                                class="absolute right-0 top-0 mr-2 mt-1 h-2 w-2 animate-ping rounded-full bg-red-500"></span>
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <main class="space-y-6 p-6 sm:p-10">
                <div class="flex flex-col justify-between space-y-6 md:flex-row md:space-y-0">
                    <div class="mr-6">
                        ...
                        <h2 class="ml-0.5 text-gray-600">Mobile UX/UI Design course</h2>
                    </div>
                    <div class="-mb-3 flex flex-wrap items-start justify-end">
                        <button
                            class="mb-3 inline-flex rounded-md border border-purple-600 px-5 py-3 text-purple-600 hover:bg-purple-100 hover:text-purple-700 focus:bg-purple-100 focus:text-purple-700">
                            <svg class="-ml-1 mr-2 mt-0.5 h-5 w-5 flex-shrink-0" aria-hidden="true" fill="none"
                        ...
                        <button
                            class="mb-3 ml-6 inline-flex rounded-md bg-purple-600 px-5 py-3 text-white hover:bg-purple-700 focus:bg-purple-700">
                            <svg class="-ml-1 mr-2 h-6 w-6 flex-shrink-0 text-white" aria-hidden="true"
                ...
                <section class="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-purple-100 text-purple-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-green-100 text-green-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-red-100 text-red-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-blue-100 text-blue-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <section class="grid gap-6 md:grid-cols-2 xl:grid-flow-col xl:grid-cols-4 xl:grid-rows-3">
                    <div class="flex flex-col rounded-lg bg-white shadow md:col-span-2 md:row-span-2">
                        <div class="border-b border-gray-100 px-6 py-5 font-semibold">The number of applied and left
                            students per month</div>
                        <div class="flex-grow p-4">
                            <div
                                class="flex h-full items-center justify-center rounded-md border-2 border-dashed border-gray-200 bg-gray-100 px-4 py-16 text-3xl font-semibold text-gray-400">
                                Chart</div>
                        </div>
                    </div>
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-yellow-100 text-yellow-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                    ...
                    <div class="flex items-center rounded-lg bg-white p-8 shadow">
                        <div
                            class="mr-6 inline-flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-full bg-teal-100 text-teal-600">
                            <svg class="h-6 w-6" aria-hidden="true" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div class="row-span-3 rounded-lg bg-white shadow">
                        <div
                            class="flex items-center justify-between border-b border-gray-100 px-6 py-5 font-semibold">
                            ...
                            <button
                                ...
                                id="options-menu" type="button" aria-haspopup="true" aria-expanded="true">
                                Descending
                    ...
                    <div class="row-span-3 flex flex-col rounded-lg bg-white shadow">
                        <div class="border-b border-gray-100 px-6 py-5 font-semibold">Students by type of studying
                        </div>
                        <div class="flex-grow p-4">
                            <div
                                class="flex h-full items-center justify-center rounded-md border-2 border-dashed border-gray-200 bg-gray-100 px-4 py-24 text-3xl font-semibold text-gray-400">
                                Chart</div>
                        </div>
                    </div>
                </section>
                <section class="text-right font-semibold text-gray-500">
                    <a class="text-purple-600 hover:underline" href="#">Recreated on Codepen</a> with <a
                        class="text-teal-400 hover:underline" href="https://tailwindcss.com/">Tailwind CSS</a> by Azri
                    Kahar, <a class="text-purple-600 hover:underline"
                        href="https://dribbble.com/shots/10711741-Free-UI-Kit-for-Figma-Online-Courses-Dashboard">original
                        design</a> made by Chili Labs
                </section>
            </main>
        </div>
    </div>
