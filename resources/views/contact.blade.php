<x-front-layout>
    ...
    <section class="relative z-20 overflow-hidden ">
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                <svg class="w-5 h-5" width="100px" height="100px" viewBox="0 0 24.00 24.00"
                                    id="meteor-icon-kit__regular-whatsapp" fill="none"
                        ...
                        <div class="p-4 md:p-5">
                            <div class="flex">
                                ...
                                <div class="grow ml-5">
                                    ...
                                    <p class="text-sm text-gray-500">
                                        Reach us at <span
                                            class="text-blue-600 font-medium dark:text-blue-500">info@costrad.org</span>
                                    </p>
                                </div>
                            </div>
                        </div>
            ...
            <div class="flex flex-col min-h-screen ">
                <div class="container flex flex-col flex-1 px-4 pb-12 mx-auto">
                    <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
                        <div class="text-white lg:w-1/2 lg:mx-6 space-y-6">
                            ...
                            <div class="grid sm:grid-cols-1 lg:grid-cols-2 gap-4">
                                ...
                                <a class="group flex flex-col bg-white border border-gray-400/40 shadow-sm rounded-xl hover:shadow-md transition dark:bg-firefly-900 dark:border-gray-800"
                                    ...
                                    <div class="p-4 md:p-5">
                                        <div class="flex">
                                            <svg class="w-6 h-6 text-firefly-500 " fill="red"
                                            ...
                                            <div class="grow ml-5">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    <span>Follow COSTrAD on TikTok</span>
                                ...
                                <a class="group flex flex-col bg-white border border-gray-400/40 shadow-sm rounded-xl hover:shadow-md transition dark:bg-firefly-900 dark:border-gray-800"
                                    ...
                                    <div class="p-4 md:p-5">
                                        <div class="flex">
                                            <x-lucide-twitter class="w-6 h-6 text-firefly-500 " />
                                            ...
                                            <div class="grow ml-5">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    <span>Follow COSTrAD on Twitter</span>
                                ...
                                <a class="group flex flex-col bg-white border border-gray-400/40 shadow-sm rounded-xl hover:shadow-md transition dark:bg-firefly-900 dark:border-gray-800"
                                    ...
                                    <div class="p-4 md:p-5">
                                        <div class="flex">
                                            <x-lucide-facebook class="w-6 h-6 text-firefly-500 " />
                                            ...
                                            <div class="grow ml-5">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    <span>Follow COSTrAD on FaceBook</span>
                                ...
                                <a class="group flex flex-col bg-white border border-gray-400/40 shadow-sm rounded-xl hover:shadow-md transition dark:bg-firefly-900 dark:border-gray-800"
                                    ...
                                    <div class="p-4 md:p-5">
                                        <div class="flex">
                                            <x-lucide-youtube class="w-6 h-6 text-red-500 " />
                                            ...
                                            <div class="grow ml-5">
                                                ...
                                                <p class="text-sm text-gray-500">
                                                    <span>Follow COSTrAD on YouTube</span>
                        ...
                        <div class="mt-8 md:w-1/2 md:mx-6">

                            <div
                                class="w-full px-4 md:p-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-gray-950 lg:max-w-xl">
                                <h1 class="text-xl font-medium text-gray-700 dark:text-gray-200">Contact form</h1>

                                <p class="mt-2 text-gray-500 dark:text-gray-400">
                                    Whether you have a question, concern, or simply want to provide feedback, our team
                                    is
                                    here to help.
                                </p>
                                ...
                                accept-charset="UTF-8" class="form-horizontal space-y-4"
                                        ...
                                        <x-button class="text-center w-full">Get in Touch</x-button>
        ...
        <div class="absolute bottom-0 right-0 z-[-1] opacity-30">
