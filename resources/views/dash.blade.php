<x-participant-layout>
    <section class="mainblock">
        <div class="innerblock delay-900 duration-900 animate-in slide-in-from-left-96">
            <div
                class="order-last flex flex-col justify-between space-y-5 border-none bg-firefly-100/60 p-2 pt-2 text-firefly-950 dark:bg-gray-950 dark:text-white md:order-first md:col-span-8 md:rounded-l-3xl md:p-6 md:pl-8 h-auto ">
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    <div class="w-full">
                        <input
                            class="block w-full rounded-full border-gray-200 px-5 py-3 text-sm focus:border-blue-500 focus:ring-blue-500 disabled:pointer-events-none disabled:opacity-50 dark:border-gray-700 dark:bg-slate-950 dark:text-gray-400 dark:focus:ring-gray-600"
