<div>
    ...
    <div class="grid md:grid-cols-2 gap-4 p-4 ">
        <div
            class="dark:border-gray-700/10  border-gray-500/10 rounded-2xl h-36 bg-gray-200/80   dark:bg-gray-950 dark:text-white p-6   shadow flex flex-col justify-between  ">
            ...
            <div class="text-sm tracking-tight">
                <span class="font-bold">Latest Donation:
                    {{ Number::currency(App\Models\Donation::all()->last()?->amount / 100, in: 'GHS') ?? 'No Donations Yet' }}
                </span>
            </div>
        </div>
        <div
            class="relativedark:border-gray-700/10  border-gray-500/10 rounded-2xl h-36 bg-gray-200/80   dark:bg-gray-950 dark:text-white  p-6   shadow flex flex-col justify-between  ">
            <div
            ...
            <div class="flex justify-between items-center">
                <div class="capitalize flex-none text-lg font-semibold dark:text-white">
                    <div class=" text-xl gap-x-2 ">
                        <span class=" text-slate-700 dark:text-slate-200">
                            {{ Number::currency($this->totalAmountForMonth()/100, in: 'GHS')  }}
                        </span>
