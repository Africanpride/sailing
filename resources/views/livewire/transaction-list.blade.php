                                ...
                                <div
                                    ...
                                    <div
                                            ...
                                            <div>
                                                <fieldset class="grid md:grid-cols-1 gap-4 w-full ">
                                                    ...
                                                    <div class="flex justify-between items-center w-full">
                                                        ...
                                                        <div
                                                            class="w-2/4 flex item-center justify-between font-bold font-sans">
                                                            <div
                                        ...
                                        <div
                                            ...
                                            <x-button class="w-full" wire:click.prevent="reverseTransaction({{ $transaction->paystackTransactionID }})">
