        ...
        <div id="instituteModal" class="space-y-4 sm:space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="space-y-2">
                    ...
                    <input id="af-submit-app-project-startDate" type="date" name="startDate" wire:model="startDate"
                        class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
                ...
                <div class="space-y-2">
                    ...
                    <input id="af-submit-app-project-endDate" type="date" name="endDate" wire:model="endDate"
                        class="py-2 px-3 pe-11 block w-full border-gray-200 shadow-sm rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600"
            ...
            <div class="space-y-2">
                ...
                <label for="banner" class="inline-block text-sm font-medium text-gray-800 mt-2.5 dark:text-gray-200">
