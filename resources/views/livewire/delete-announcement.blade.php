<x-institute-modal formAction="deleteAnnouncement">
    <x-slot name="title">
        Delete Confirmation
    </x-slot>
    ...
    <x-slot name="content">
        <div class="text-current dark:text-white text-md">
            Are you sure you want to delete <span class="text-red-500 font-bold">{{ $announcement->title }}</span>? Action cannot be reversed.
        </div>
    </x-slot>
